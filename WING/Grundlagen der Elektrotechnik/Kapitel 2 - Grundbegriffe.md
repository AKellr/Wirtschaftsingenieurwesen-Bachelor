...
- Formel: $Q = n · e$ wobei n eine ganze Zahl ist.
...
**Formel**: $U_{BA}=\frac{(W_{B}-W_{A})}{Q}$, wobei $W$ die potentielle Energie und $Q$ die transportierte Ladung ist.
**Einheit**: Die Einheit der Spannung ist das Volt (V), wie im Text impliziert. Aus der Formel ergibt sich $1 V = 1\frac{J}{C}$.
...
**Einheit**: Die Einheit des Widerstands ist das **Ohm (Ω)**. 1 Ω = 1 $\frac{V}{A}$.
...
**Spezifischer Widerstand (ρ)**: Eine Materialkonstante mit der Einheit $Ω·m$.
**Elektrische Leitfähigkeit (σ)**: Der Kehrwert des spezifischen Widerstands (σ = $\frac{1}{\rho}$).
...
- Bei konstanten Größen: $P = U · I$.
- Bei zeitlich veränderlichen Größen u(t) und i(t) wird die **Momentanleistung** betrachtet: $p(t) = u(t) · i(t)$.
